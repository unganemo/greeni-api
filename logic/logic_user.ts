import { sign_up_c, login_c, get_kitchen_invites_c } from "../cache/cache_user";
...
export const get_kitchen_invites_l = async (request: string) => {
  return await get_kitchen_invites_c(request);
};
